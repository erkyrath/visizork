// gnusto-lib.js || -*- Mode: Javascript; tab-width: 4; -*-
...
// Debug tool: display an effect in human-readable form.
function label_for_effect(val)
{
    switch (val) {
    case GNUSTO_EFFECT_INPUT: return 'INPUT';
    case GNUSTO_EFFECT_INPUT_CHAR: return 'INPUT_CHAR';
    case GNUSTO_EFFECT_SAVE: return 'SAVE';
    case GNUSTO_EFFECT_RESTORE: return 'RESTORE';
    case GNUSTO_EFFECT_QUIT: return 'QUIT';
    case GNUSTO_EFFECT_RESTART: return 'RESTART';
    case GNUSTO_EFFECT_WIMP_OUT: return 'WIMP_OUT';
    case GNUSTO_EFFECT_BREAKPOINT: return 'BREAKPOINT';
    case GNUSTO_EFFECT_FLAGS_CHANGED: return 'FLAGS_CHANGED';
    case GNUSTO_EFFECT_PIRACY: return 'PIRACY';
    case GNUSTO_EFFECT_STYLE: return 'STYLE';
    case GNUSTO_EFFECT_SOUND: return 'SOUNBD';
    case GNUSTO_EFFECT_SPLITWINDOW: return 'SPLITWINDOW';
    case GNUSTO_EFFECT_SETWINDOW: return 'SETWINDOW';
    case GNUSTO_EFFECT_ERASEWINDOW: return 'ERASEWINDOW';
    case GNUSTO_EFFECT_ERASELINE: return 'ERASELINE';
    case GNUSTO_EFFECT_SETCURSOR: return 'SETCURSOR';
    case GNUSTO_EFFECT_SETBUFFERMODE: return 'SETBUFFERMODE';
    case GNUSTO_EFFECT_SETINPUTSTREAM: return 'SETINPUTSTREAM';
    case GNUSTO_EFFECT_GETCURSOR: return 'GETCURSOR';
    case GNUSTO_EFFECT_PRINTTABLE: return 'PRINTTABLE';
    default: return val;
    }
}
...
function handleZ_restart(engine, a) {
    engine.m_compilation_running=0;
    return "m_effects=["+GNUSTO_EFFECT_ERASEWINDOW+",0];resetStory();return";
}
...
function GnustoEngine(logfunc) {
    ...
    this.label_for_effect = label_for_effect;
}
